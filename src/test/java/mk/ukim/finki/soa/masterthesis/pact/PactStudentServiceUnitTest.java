...
class PactStudentServiceUnitTest {
    ...
    void whenGetStudentById_thenReturnStudent(MockServer mockServer) {
        ...
        assertThat(response.getBody()).contains("Student:00000000-0000-0000-0000-000000000001", "Anastasija Tashkova", "anastasija.tashkova@students.finki.ukim.mk", "211299", "Software engineering and information systems", "4");
    }
}
